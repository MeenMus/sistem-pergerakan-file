...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Unreturned Files</h1>
      </div>
      <div class="col-sm-6">
    ...
    <table class="table table-head-fixed text-nowrap" style="width: 100%;" id="table" data-sort-order="desc" data-pagination="true" data-page-size="6" data-pagination-parts="['pageInfo', 'pageList']">
      ...
      <tbody id="myTable">
        ...
        <tr>
          ...
          <td>{{ $file->email }}</td>
          <td><a href="/manage-checkin/{{ collect(request()->segments())->last() }}/{{$file->applicant_id}}" style="font-weight:bold; font-size:20px;">{{ $file->total }}</a></td>
        </tr>
        @endforeach
      </tbody>
    </table>
