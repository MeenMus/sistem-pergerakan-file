...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Check Out Files</h1>
            </div>
            <div class="col-sm-6">
...
<form action="manage-checkout" method="POST" enctype="multipart/form-data">
    ...
    <div class="card mx-auto" style="width:97%;">
        ...
        <div id = "myDIV" class="card-body table-responsive p-0" style="max-height: 370px;">
        ...
        <div class="card-footer noPrint" style="height: 60px">
            ...
            <button type="submit" style="margin:5px; margin-top:-2px;" class="btn btn-primary float-right" name="value" value='1'>Check Out </button>
            <button type="submit" style="margin:5px; margin-top:-2px;" class="btn btn-primary float-right" name="value" value='0'>Cancel</button>
        </div>
    </div>
</form>
