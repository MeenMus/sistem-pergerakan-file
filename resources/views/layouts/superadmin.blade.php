...
<body class="hold-transition sidebar-mini layout-fixed">
          ...
          <div class="navbar-search-block" style="display: none;">
            <form action="/search" method="POST" class="form-inline">
              ...
              <div class="input-group input-group-sm">
                <input class="form-control form-control-navbar" name="search" type="search" placeholder="Search by File/Name/Metric/IC" aria-label="Search">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <span class="d-block" style="color:white; white-space:break-spaces;">{{auth()->user()->name}}</span>
          </div>
        </div>
        ...
        <nav class="mt-2" style="min-height:600px;">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="/view-archive/all-files" class="nav-link {{ (request()->is('view-archive/*','view-archive-file/*')) ? 'active' : 'nav-link' }}">
            ...
            <li class="nav-item">
              <a href="/view-unarchive-file/all-files" class="nav-link {{ (request()->is('view-unarchive-file/*')) ? 'active' : 'nav-link' }}">
  ...
  <script>
    ...
    Swal.fire({
      icon: 'success',
      title: 'Archive Number Edited!',
      text: 'Succesfully edited archive number',
      confirmButtonColor: '#337DFF',
    })
    @endif

    @if($message = Session::get('editcenter'))
    Swal.fire({
      icon: 'success',
      title: 'Archive Center Edited!',
      text: 'Succesfully edited archive center',
      confirmButtonColor: '#337DFF',
    })
    @endif
    ...
    Swal.fire({
      icon: 'success',
      title: 'SUCCESS!',
      text: 'Successfully imported files!',
      confirmButtonColor: '#337DFF',
    })
    @endif
  </script>
