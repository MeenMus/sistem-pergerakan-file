        ...
        <div class="col-12" id="accordion">
                ...
                <div id="collapseTwo" class="collapse" data-parent="#accordion">
                    <div class="card-body">
                        ...
                        <div style = "margin-top:70px">
                            <img src="../../dist/img/manual/import-file.png" style="width:1000px; height:900px; margin-left:40px;" alt="createfile.png">
                        </div>
                    </div>
                </div>
            </div>
            <div class="card card-primary card-outline">
                ...
                <div id="collapseThree" class="collapse" data-parent="#accordion">
                    <div class="card-body">
                        <img src="../../dist/img/manual/center-control.png" style="width:1000px; height:900px; margin-left:40px;" alt="createcenter.png">
                    </div>
                </div>
            </div>
            <div class="card card-primary card-outline">
            ...
            <div class="card card-primary card-outline">
                ...
                <div id="collapseSix" class="collapse" data-parent="#accordion">
                    <div class="card-body">
                        <img src="../../dist/img/manual/archive.png" style="width:1000px; height:1000px; margin-left:40px;" alt="archive.png">
                    </div>
                </div>
            </div>
            <div class="card card-primary card-outline">
                ...
                <div id="collapseSeven" class="collapse" data-parent="#accordion">
                    <div class="card-body">
                        <img src="../../dist/img/manual/unarchive.png" style="width:1000px; height:1000px; margin-left:40px;" alt="unarchive.png">
                    </div>
                </div>
            </div>
            <div class="card card-primary card-outline">
            ...
            <div class="card card-primary card-outline">
                ...
                <div id="collapseSixteen" class="collapse" data-parent="#accordion">
                    <div class="card-body">
                        <img src="../../dist/img/manual/user-control.png" style="width:1000px; height:900px; margin-left:40px;" alt="search.png">
                    </div>
                </div>
            </div>
        </div>
